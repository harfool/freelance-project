...
import { Download, Eye, Calendar, Award, TrendingUp, FileText } from "lucide-react"
            ...
            <Card key={result.id}>
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={result.status === "Pass" ? "default" : "destructive"} className="text-lg px-4 py-2">
                    {result.status}
                  </Badge>
                </div>
              </CardHeader>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid md:grid-cols-4 gap-4">
                  ...
                  <Card>
                    <CardContent className="p-4 text-center">
                      <div className="text-2xl font-bold text-blue-600">{result.grade}</div>
