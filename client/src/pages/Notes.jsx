        ...
        <div className="container max-w-4xl mx-auto px-4 flex flex-col sm:flex-row sm:items-center sm:justify-between h-auto sm:h-16 py-4 sm:py-0 gap-2 sm:gap-0">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Access your course notes and assignments
            </p>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {studyMaterials.filter((m) => m.downloaded).length}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {studyMaterials.filter((m) => m.type === "Notes").length}
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {
                      studyMaterials.filter((m) => m.type === "Assignment")
                        .length
                    }
                  </p>
                </div>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      openPdfViewer(
                        ...
                        "RS-CIT Sample Paper - April 2025"
                      )
                    }
                  >
